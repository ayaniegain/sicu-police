...
function SignUp() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (response) => {
      ...
      if (response.message === "Police Station Name or Email already exists") {
  ...
  const handleContinue = async () => {
    try {
      if (image) {
        ...
        formData.append("policeStationName", psname); // Police Station name
        ...
        formData.append("officerPhoneNumber", officerno);
