const validate = (values) => {
  ...
  } else if (values.psname.length < 3) {
    errors.psname = 'Police station name should be more than 3 characters';
  }
  ...
  else if (values.areaofaction.length < 3) {
    errors.areaofaction = 'area should be at least 3 characters long';
  }
  ...
  if (!values.officerno) {
    errors.officerno = 'Officer name is required';
  }
  else if (values.officerno.length < 3) {
    errors.officerno = 'Officer name  at least 3 characters long';
  }
